<template>
    <div id="box">
        ...
        <el-col :span="8">
            ...
            <img src="../../../../assets/reader.png" class="image">
        ...
        <el-col :span="8">
            <el-card :body-style="{ padding: '0px' }">
            <img src="../../../../assets/writer.jpg" class="image">
            <div style="padding: 14px;">
                <span>作者</span><br>
        ...
        <el-col :span="8">
            <el-card :body-style="{ padding: '0px' }">
            <img src="../../../../assets/taster.png" class="image">
            <div style="padding: 14px;">
                <span>审稿人</span><br>
      ...
      <el-row>
        <el-col :span="8">
            <el-card :body-style="{ padding: '0px' }">
            <img src="../../../../assets/reviews.png" class="image">
            <div style="padding: 14px;">
                <span>评论</span><br>
        ...
        <el-col :span="8">
            <el-card :body-style="{ padding: '0px' }">
            <img src="../../../../assets/art.jpg" class="image">
            <div style="padding: 14px;">
                <span>文章</span><br>
